...
class PEtsyFeed extends PXMLFeed
{
    function __construct()
    {
        ...
        $this->addAttributeMapping('current_category', 'g:etsy_category', true, true);
