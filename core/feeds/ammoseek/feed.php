...
class PAmmoSeekFeed extends PBasicFeed
{
    ...
    function __construct()
    {
        ...
        $this->addAttributeMapping('numrounds', 'numrounds', true, true); //number of rounds for a given price
        ...
        $this->addAttributeMapping('', 'product_type', true);
        $this->addAttributeMapping('', 'gun', true);
        $this->addAttributeMapping('', 'bullet_type', true);
        ...
        $this->addAttributeMapping('', 'condition', true);
        $this->addAttributeMapping('', 'purchaselimit', true);
        $this->addAttributeMapping('', 'extra1', true);
        $this->addAttributeMapping('', 'extra2', true);
        $this->addAttributeMapping('', 'extra3', true);
      ...
      <product Type="' . $this->current_category . '">';
        ...
        foreach ($this->attributeMappings as $thisAttributeMapping)
            if ($thisAttributeMapping->enabled && !$thisAttributeMapping->deleted && !empty($product->attributes[$thisAttributeMapping->attributeName])) {
                ...
                if ($thisAttributeMapping->mapTo == 'bullet_type')
