...
class PLicense {
	...
	public $valid = false;
	protected $strErrorMsgMain = '  You are using the free version (limited to 50 items per feed). Get the pro version or a free trial key at: <a target=\'_blank\' href = \'http://exportfeed.com/\'>exportfeed.com</a> ';
